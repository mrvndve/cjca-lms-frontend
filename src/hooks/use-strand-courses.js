...
const useStrandCourses = () => {
  ...
  const deleteSectionStrands = async () => {
    setLoading(true);
    ...
    await axios.post(`${axiosUrl}/strand_course/delete`, formData, axiosConfig)
      .then(({data}) => {
        selected.map((data) => {
    ...
    },
    {
      ...
      actionItems: [
        { 
          ...
          label: 'Edit', 
          action: (e, rowData) => navigate('/admin/strand-courses/edit', { state: rowData }),
        },
        { 
...
export default useStrandCourses;