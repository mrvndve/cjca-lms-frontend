...
const useSubjectAssignExamsForm = ({
  isModalOpen,
  handleClose,
  ...
  const onSubmit = async (data, e) => {
    ...
    await axios.post(`${axiosUrl}/subject/add_exam`, data, axiosConfig)
      .then(({data}) => {
        handleSetAssignedExams(data.data);
...
export default useSubjectAssignExamsForm;